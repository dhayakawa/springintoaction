@extends('springintoaction::frontend.auth.layout', ['title' => __('springintoaction::auth.password.title'), 'bodyClass' => 'hold-transition login-page'])
...
@section('content')
    @component('springintoaction::frontend.auth.loginbox')
        ...
        {!! Form::close() !!}
        <a href="{{ route('login') }}">{{ __('springintoaction::auth.password.login_link') }}</a><br>
    @endcomponent
@endsection

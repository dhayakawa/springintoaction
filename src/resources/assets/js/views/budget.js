(function (App) {
    App.Views.Budget = Backbone.View.extend({
        ...
        render: function () {
            ...
            var backgrid = new Backgrid.Grid({
                header: Header,
                columns: App.Vars.BudgetsBackgridColumnCollection,
                collection: this.collection
            });

            // Hide db record foreign key ids
            var hideCellCnt = 2;
            var initialColumnsVisible = App.Vars.BudgetsBackgridColumnDefinitions.length - hideCellCnt;
            var colManager = new Backgrid.Extension.ColumnManager(App.Vars.BudgetsBackgridColumnCollection, {
        ...
        update: function (e) {
            ...
            App.Models.budgetModel.save(_.extend({BudgetID: e.attributes.BudgetID}, e.changed),
                {

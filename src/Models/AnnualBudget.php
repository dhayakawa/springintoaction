        ...
        public function getSiteBudgets($Year)
        {
            ...
            foreach ($aSites as $site) {
                ...
                foreach ($aProjects as $key => $aaProject) {
                    //echo '<pre>key:'. $key . ' ' . print_r($aaProject, true).'</pre>';
                    $aSiteBudgets['Sites'][$site['SiteName']]['Projects'][$aaProject['SequenceNumber']]['Budget Source'] = [];
                    $aBudgets =
                    ...
                    $aSiteBudgets['Sites'][$site['SiteName']]['Projects'][$aaProject['SequenceNumber']]['Est Cost'] = $aaProject['estimated_total_cost'];
